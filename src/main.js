...
{    
 ...
 if (((Math.abs(playerX-statusAgent1.x))<50) && ((Math.abs(playerY+40-statusAgent2.y))<70)){livesMinus()}
 if (((Math.abs(playerX-statusAgent2.x))<50) && ((Math.abs(playerY+40-statusAgent2.y))<70)){livesMinus()}
 if (((Math.abs(playerX-statusAgent3.x))<50) && ((Math.abs(playerY+40-statusAgent3.y))<70)){livesMinus()}
}
...
function livesMinus()
{
    ...
    if (gameLives===0) {gameStatus="lost"}
